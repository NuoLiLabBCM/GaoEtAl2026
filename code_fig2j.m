...
func_plot_mean_and_sem(time_bins(time_bins<=3.2),mean_trace(:,time_bins<=3.2,1),[0 0 0],[.7 .7 .7],'none',1);
func_plot_mean_and_sem(time_bins(time_bins<=4.2),mean_trace(:,time_bins<=4.2,2),[.5 .5 .7],[.8 .8 1],'none',1);
func_plot_mean_and_sem(time_bins(time_bins<=4.2),mean_trace(:,time_bins<=4.2,3),[.5 .5 0],[1  1 .5],'none',1);
