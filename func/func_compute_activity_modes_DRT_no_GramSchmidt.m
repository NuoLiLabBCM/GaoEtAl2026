...
orthonormal_basis_gram = Gram_Schmidt_process([CD_stim_mode CD_choice_mode CD_outcome_mode CD_sample_mode CD_delay_mode CD_go_mode Ramping_mode GoDirction_mode v]);

orthonormal_basis = [CD_stim_mode CD_choice_mode CD_outcome_mode CD_sample_mode CD_delay_mode CD_go_mode Ramping_mode GoDirction_mode orthonormal_basis_gram(:,9)];
